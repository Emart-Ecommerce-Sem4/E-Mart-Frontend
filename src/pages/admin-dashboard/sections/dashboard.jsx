...
import api from '../../../api';
import subCategory from '../../../api/modules/subCategory';
...
export default function Dashboard(props) {
  var months=[{label:"January",val:1},{label:"February",val:2},{label:"March",val:3},{label:"April",val:4},{label:"May",val:5},{label:"June",val:6},{label:"July",val:7},{label:"August",val:8},{label:"September",val:9},{label:"October",val:10},{label:"November",val:11},{label:"December",val:12}]
  ...
  const [overViewOfMostSalesYear, setOverViewOfMostSalesYear] = useState('2022');
 const [totalOrdersYear,settotalOrdersYear]=useState('2022');
  ...
  var [quaterlySales,setQuaterlySales] = useState([{"quater":1,"sales":0},{"quater":2,"sales":0},{"quater":3,"sales":0},{"quater":4,"sales":0}]);
  var [salesReport,setTotalSales]= useState([{"tatotal_sale":0},{"rejected_sale":0},{"refunded_sales":0},{"shoppickup_sales":0},{"delivery_sales":0}])
  var [ordersReport,setTotalOrders]=useState([{"total_orders":0},{"placed_orders":0},{"shiped_orders":0},{"delivered_orders":0},{"rejected_orders":0},{"refunded_orders":0},{"store_pickup_orders":0},{"deliver_orders":0}])
 ...
 const rows = [];
  ...
  async function getQuaterlySalesReport(year){
    try {
      ...
      var row =[{"quater":1,"sales":0},{"quater":2,"sales":0},{"quater":3,"sales":0},{"quater":4,"sales":0}]
      if (res?.statusCode === 200) {
  ...
  async function getSalesReport(year){
    try {
      ...
      var row =[{"tatotal_sale":0},{"rejected_sale":0},{"refunded_sales":0},{"shoppickup_sales":0},{"delivery_sales":0}]
      if (res?.statusCode === 200) {
  ...
  async function getOrdersReport(year){
    try {
      ...
      var row =[{"total_orders":0},{"placed_orders":0},{"shiped_orders":0},{"delivered_orders":0},{"rejected_orders":0},{"refunded_orders":0},{"store_pickup_orders":0},{"deliver_orders":0}]
      if (res?.statusCode === 200) {
            ...
            if (element?.order_status) {
             switch (element?.order_status) {
              ...
              if (element?.total_orders) {
                ...
                switch (element?.delivery_method) {
                  case "DELIVERY":
                    row[7].deliver_orders=element.total_orders_on_delevery_method
                    break;
                  case "STORE_PICKUP":
                    row[6].store_pickup_orders=element.total_orders_on_delevery_method
                    break;
...
async function getTotalSalesAccordingTotime(year,fromMonth,toMonth) {
  try {
    ...
    const [code, res] = await api.report.getmostSalesAccordingToTime(year,fromMonth,toMonth);
    ...
    <div style={{ padding: 20 }}>
      ...
      <Grid item xs={12} sx={{ mb: -2.25 }}>
            ...
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title="Total Sales " count={salesReport[0].tatotal_sale}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title="Refunded Sales " count={salesReport[2].refunded_sales}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Rejected Sales " count={salesReport[1].rejected_sale}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Storepickup Sales" count={salesReport[3].shoppickup_sales}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Delivery Sales" count={salesReport[4].delivery_sales}  isLoss color="warning"  />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title="Total Orders " count={ordersReport[0].total_orders}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title="Placed orders " count={ordersReport[1].placed_orders}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Shiped orders " count={ordersReport[2].shiped_orders}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title="Completed orders" count={ordersReport[3].delivered_orders}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Rejected Orders" count={ordersReport[4].rejected_orders}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Refunded Orders" count={ordersReport[5].refunded_orders}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Storepickup Orders" count={ordersReport[6].store_pickup_orders}  isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
                <AnalyticEcommerce title=" Delivery Orders" count={ordersReport[7].deliver_orders}  isLoss color="warning"  />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Total Sales of January - March " count={quaterlySales[0].sales} percentage={calculatePercentageQuaterLysale(0)}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Total Sales of April - June" count={quaterlySales[1].sales} percentage={calculatePercentageQuaterLysale(1)}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Total Sales of July-september" count={quaterlySales[2].sales} percentage={calculatePercentageQuaterLysale(2)} isLoss color="warning"  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Total Sales of October-december" count={quaterlySales[3].sales} percentage={calculatePercentageQuaterLysale(3)} isLoss color="warning"  />
            </Grid>
            ...
            <CssBaseline />
              <Grid marginBottom={1} container alignItems="center"  columnSpacing={3}>
                <Grid item>
                ...
                <Grid item>
                  ...
                  onChange={(event, value) => {
                    ...
                    setYear(value?.year);
                    if (value) {
                      getTotalSalesAccordingTotime(value?.year,fromMonthValue,toMonthValue)
                    }
        ...
        onChange={(event, value) => {
          ...
          getTotalSalesAccordingTotime(overViewOfMostSalesYear,value?.val,toMonthValue)
        }}
        
        id="combo-box-demo"
        options={months}
        sx={{ width: 170 }}
        renderInput={(params) => <TextField {...params} label="From Month" />}
      />
                    </Box>
                    </Grid>
                    <Grid item>
                    ...
                    onChange={(event, value) => {
                      ...
                      getTotalSalesAccordingTotime(overViewOfMostSalesYear,fromMonthValue,value?.val);
                    ...
                    sx={{ width: 170 }}
                    renderInput={(params) => <TextField {...params} label="To Month" />}
                  />
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Category with most sales" count={totalSalesAccordingToTime[0].max} percentage={totalSalesAccordingToTime[0].percentage} extra={totalSalesAccordingToTime[0].category_name}  />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Sub category with most sales" count={totalSalesAccordingToTime[1].max} percentage={totalSalesAccordingToTime[1].percentage}  extra={totalSalesAccordingToTime[1].title}/>
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Product with most sales" count={totalSalesAccordingToTime[2].max} percentage={totalSalesAccordingToTime[2].percentage} isLoss color="primary" extra={totalSalesAccordingToTime[2].name} />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AnalyticEcommerce title="Product varient with most sales" count={totalSalesAccordingToTime[3].max} percentage={totalSalesAccordingToTime[3].percentage} isLoss color="warning" extra={totalSalesAccordingToTime[3].variant_type} />
            </Grid>
